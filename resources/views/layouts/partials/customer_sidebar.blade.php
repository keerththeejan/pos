<aside class="tw-sticky tw-top-0 tw-z-30 tw-hidden lg:tw-flex tw-h-screen tw-overflow-y-auto tw-bg-white tw-w-64 tw-flex-col tw-shrink-0 tw-border-r tw-border-gray-200"><aside class="tw-sticky tw-top-0 tw-z-30 tw-flex tw-h-screen tw-overflow-y-auto tw-bg-white tw-w-64 tw-flex-col tw-shrink-0 tw-border-r tw-border-gray-200">
    ...
    <nav class="tw-flex-1 tw-py-2">
        <ul class="tw-space-y-1">
            ...
            <li>
                <a href="{{ route('customer.invoices') }}" class="tw-flex tw-items-center tw-gap-2 tw-px-4 tw-py-2.5 hover:tw-bg-gray-100 tw-text-gray-700">
                    <span>Invoices</span>
                </a>
            </li>
            <li>
                <a href="{{ route('customer.order_templates') }}" class="tw-flex tw-items-center tw-gap-2 tw-px-4 tw-py-2.5 hover:tw-bg-gray-100 tw-text-gray-700">
                    <span>Order Templates</span>
                </a>
            </li>
            <li>
                <a href="{{ route('customer.speed_order') }}" class="tw-flex tw-items-center tw-gap-2 tw-px-4 tw-py-2.5 hover:tw-bg-gray-100 tw-text-gray-700">
